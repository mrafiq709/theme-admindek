              ...
              <div class="latest-update-box">
                <div class="row p-t-20 p-b-30">
                  <div class="col-auto text-right update-meta p-r-0">
                    <img src="{{asset('assets/media/jpg/avatar-4.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
                  </div>
                  <div class="col p-l-5">
        ...
        <div class="col-xl-6 col-md-12">
          <div class="card new-cust-card">
            ...
            <div class="card-block">
              ...
              <div class="align-middle m-b-35">
                <img src="{{asset('assets/media/jpg/avatar-3.jpg')}}" alt="user image" class="img-radius img-40 align-top m-r-15">
                <div class="d-inline-block">
